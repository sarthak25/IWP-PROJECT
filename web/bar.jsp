<%-- 
    Document   : bar
    Created on : 6 OCT, 2018, 1:19:20 PM
    Author     : SHUBHAM
--%>
...
<html>
    ...
    <body>
        <div>
                <div style="float: left; width: 580px; margin: 8px 0px 5px 200px; font-size: 20px;"><marquee behavior="alternate"  direction="left" style="text-align:center;">Online QUIZ</marquee></div>
                <%
